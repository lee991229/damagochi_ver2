...
"}")
        ...
        self.pushButton_2 = QtWidgets.QPushButton(self.frame_btns)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.stackedWidget_damagochi.setCurrentIndex(2)
    ...
    def retranslateUi(self, frame_damagochi):
        ...
        self.label_4.setText(_translate("frame_damagochi", "이미지"))
        ...
        self.pushButton.setText(_translate("frame_damagochi", "회원가입"))
        self.pushButton_2.setText(_translate("frame_damagochi", "로그인"))
