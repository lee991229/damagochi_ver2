...
"")
        ...
        self.label_member_icon.setPixmap(QtGui.QPixmap(":/newPrefix/user-minus-l.svg"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/newPrefix/user-l.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
